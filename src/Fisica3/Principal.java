...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Este programa realiza a mesma função de calculadora");

        System.out.println("Escolha qual dos calculos abaixo:");
        System.out.println("1 - Força Centripeta");
